...
- Passwordless email links are generated by the API. Local development exposes `/dev/auth/inbox`; production sends them through SMTP when `Smtp__Host` is configured.
