              ...
              {protocols.length === 0 ? (
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {protocols.map((protocol) => (
                    <article
                      key={protocol.id}
                      className="rounded-lg border border-white/[0.08] bg-[#121923]/90 transition-colors hover:border-emerald-400/30"
                    >
                      <Link href={`/protocols/${protocol.id}`} className="block p-5 pb-3">
