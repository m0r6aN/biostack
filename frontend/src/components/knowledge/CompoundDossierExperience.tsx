...
interface CompoundDossierExperienceProps {
  slug: string;
  initialEntry?: KnowledgeEntry | null;
}

export function CompoundDossierExperience({ slug, initialEntry = null }: CompoundDossierExperienceProps) {
  const { user, loading: authLoading } = useAuth();
  const [entry, setEntry] = useState<KnowledgeEntry | null>(initialEntry);
