...
export interface ProtocolIntelligenceResponse {
  status: 'Unknown' | 'Available' | string;
  phaseMap: ProtocolIntelligencePhaseMapItem[];
  relationships: ProtocolIntelligenceRelationshipCard[];
  ambiguitySignals: ProtocolIntelligenceAmbiguitySignal[];
  sourceQualityWarnings: ProtocolIntelligenceSourceQualityWarning[];
  highRiskWarnings: ProtocolIntelligenceHighRiskWarning[];
  unknowns: string[];
  safetyNotes: string[];
  upgradeHooks: ProtocolIntelligenceUpgradeHook[];
}

export interface ProtocolIntelligencePhaseMapItem {
  phase: string;
  label: string;
  evidenceTier: string;
  confidence: string;
...
export interface ProtocolIntelligenceRelationshipCard {
...
export interface ProtocolIntelligenceAmbiguitySignal {
  symptomOrOutcome: string;
  onsetWindow: string;
...
export interface ProtocolIntelligenceSourceQualityWarning {
  subject: string;
  sourceClass: string;
...
export interface ProtocolIntelligenceHighRiskWarning {
  category: string;
...
export interface ProtocolIntelligenceUpgradeHook {
  requiredTier: string;
  featureCode: string;
  message: string;
}
