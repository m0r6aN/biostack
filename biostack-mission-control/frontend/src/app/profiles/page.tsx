          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {profiles.map((profile) => (
              <Link
                ...
                className="group relative p-6 rounded-2xl border border-white/[0.08] bg-[#121923]/90 hover:border-white/[0.15] hover:-translate-y-[1px] transition-all duration-150 cursor-pointer"
              >
