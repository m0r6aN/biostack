    ...
    <div className="min-h-screen" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <main>
        ...
        <section className="min-h-[calc(100svh-73px)] border-b border-white/8">
          <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:py-20">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-white/62">
                Track compounds with precision. Detect pathway overlaps. Spot patterns in your data.
                BioStack is the operating system your protocol has been missing.
              </p>
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-[radial-gradient(circle_at_top,#153827,transparent_38%),linear-gradient(145deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-8 shadow-[0_24px_90px_rgba(0,0,0,0.45)]">
              <div className="grid gap-8 md:grid-cols-[0.8fr_1.2fr]">
                <div className="space-y-5">
                  <p className="text-xs uppercase tracking-[0.24em] text-white/36">Mission Control</p>
                  <div>
                    <p className="text-sm text-white/42">System mode</p>
                    <p className="mt-1 text-2xl font-semibold text-white">Observer → Operator</p>
                  </div>
                  <div>
                    <p className="text-sm text-white/42">Current stack</p>
                    <p className="mt-1 text-2xl font-semibold text-white">5 active compounds</p>
                  </div>
                </div>

                <div className="space-y-4">
                  {landingFeatures.slice(0, 4).map((feature) => (
                    <div key={feature} className="border-b border-white/8 pb-4 text-sm text-white/62">
                      <p className="text-white/92">{feature}</p>
                    </div>
                  ))}
                </div>
              </div>
