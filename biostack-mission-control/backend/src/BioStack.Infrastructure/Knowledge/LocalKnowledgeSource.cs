    ...
    private static List<KnowledgeEntry> InitializeKnowledgeBase()
    {
        return new List<KnowledgeEntry>
        {
            new KnowledgeEntry
            {
                ...
                Benefits = new List<string> { "improved healing", "gut health", "injury recovery" },
            ...
            new KnowledgeEntry
            {
                ...
                Benefits = new List<string> { "improved healing", "reduced inflammation", "tissue repair" },
            ...
            new KnowledgeEntry
            {
                ...
                Benefits = new List<string> { "metabolic health", "energy", "insulin sensitivity" },
                ...
                OptimizationSupplements = "Creatine (5g), CoQ10 (200mg)"
            },
            new KnowledgeEntry
            {
                CanonicalName = "NAD+",
                ...
                OptimizationSupplements = "Quercetin, Folate (400mcg), Vitamin D (5000 IU)"
            },
            new KnowledgeEntry
            {
