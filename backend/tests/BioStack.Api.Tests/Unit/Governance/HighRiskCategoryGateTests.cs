...
public class HighRiskCategoryGateTests
{
    ...
    [InlineData("Cardarine", HighRiskCategory.InvestigationalResearchChemical)]
    [InlineData("SR9009", HighRiskCategory.InvestigationalResearchChemical)]
    [InlineData("MK-677", HighRiskCategory.InvestigationalResearchChemical)]
